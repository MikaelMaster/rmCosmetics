            ...
            click = ClickEffect {
                ...
                if (compravelporgold == true) {
                    if (user.gold >= companionpreco!!) {
                        ...
                        MenuConfirmGoldItemBuy.instance.backMenu[player] = MenuCompanions.instance
                        MenuConfirmCashItemBuy.instance.buyingItem[user] =
                            "Companheiro - ${companion.name} (Lobby)"
                        MenuConfirmGoldItemBuy.instance.buyingItemPermission[user] = companion.permission
                        MenuConfirmGoldItemBuy.instance.buyingItemPrice[user] = companionpreco
                        MenuConfirmGoldItemBuy.instance.buyingItemMaterial[user] =
                            ItemBuilder(companion.symbol)
            ...
            click = ClickEffect {
                ...
                if (compravelporcash == true) {
                    if (user.cash >= companionpreco!!) {
                        ...
                        MenuConfirmCashItemBuy.instance.backMenu[player] = MenuCompanions.instance
                        MenuConfirmCashItemBuy.instance.buyingItem[user] =
                            "Companheiro - ${companion.name} (Lobby)"
                        MenuConfirmCashItemBuy.instance.buyingItemPermission[user] = companion.permission
                        MenuConfirmCashItemBuy.instance.buyingItemPrice[user] = companionpreco
