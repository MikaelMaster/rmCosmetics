...
class MenuConfirmPetBuy2 : Menu("Confirmar Compra?", 4) {
    companion object {
        lateinit var instance: MenuConfirmPetBuy2
    }

    val comprando = mutableMapOf<Player, MiftPet>()

    init {
        instance = this@MenuConfirmPetBuy2
        ...
        button("confirm-buy") {
            ...
            iconPerPlayer = {
                ...
                item.lore(
                    ...
                    "",
                    "§fIsto custará: §b${pet.cashPrice.format(false)} Cash"
                )
                item
            }
            ...
            button("confirm") {
                ...
                click = ClickEffect {
                    ...
                    if (user.cash >= pet.cashPrice) {
                        player.closeInventory()
                        CoreGeneralUtils.buyProductWithCash(player, pet.cashPrice, "Pet - ${pet.display}")
                        ...
                        player.sendMessage("§aValor gasto: §b${pet.goldPrice.format(false)} Cash§a.")
