...
class MenuConfirmCompanionBuy2 : Menu("Confirmar Compra?", 4) {
    ...
    init {
        instance = this@MenuConfirmCompanionBuy2
            ...
            button("confirm") {
                ...
                click = ClickEffect {
                    ...
                    if (user.cash >= companionpreco) {
                        player.closeInventory()
                        CoreGeneralUtils.buyProductWithCash(player, companionpreco, "Companheiro - ${companion.name}")
                        ...
                        player.sendMessage("§aValor gasto: §b${companionpreco.format(false)} Cash§a.")
